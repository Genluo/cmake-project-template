...
class DividerTest : public ::testing::Test {
  ...
  protected:
    std::VI numerators = {5, 9, 17, 933345453464353416L};
    std::VI denominators = {2, 3, 19, 978737423423423499L};
    std::VI divisions = {2, 3, 0, 0};
    std::VI remainders = {1, 0, 17, 933345453464353416};
